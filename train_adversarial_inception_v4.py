...
if __name__=="__main__":
	...
	'''
	train_step=tf.train.GradientDescentOptimizer(0.001).minimize(cross_entropy,var_list=[fc0_weights,fc0_biases])
	...
	with tf.Session() as sess:
		...
		print("======================================================")
		print("迭代结束！")
		print(loss_avg/(count*num_epochs),acc_avg/(count*num_epochs))
